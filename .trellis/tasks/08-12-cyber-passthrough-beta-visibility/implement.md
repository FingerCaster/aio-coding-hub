...
7. [ ] 提交、推送修复分支，创建 PR，等待 CI 全绿后合入 `origin/main`。
8. [ ] 重新读取远端版本状态，以合入后的不可变 SHA 发布下一公开 Beta。
9. [ ] 验证 Release、资产、签名、manifest、Beta pointer 和 stable 隔离；报告安装/验证方式。
10. [ ] 清理已完成的独立 worktree，完成 Trellis 归档和开发日志。
