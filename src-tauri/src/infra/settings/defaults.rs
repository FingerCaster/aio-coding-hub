...
pub(super) const SCHEMA_VERSION_ADD_STREAM_TERMINAL_FIREWALL: u32 = 58;
pub(super) const SCHEMA_VERSION_MIGRATE_STREAM_TERMINAL_FIREWALL: u32 = 59;
pub(super) const SCHEMA_VERSION_ADD_CODEX_INFINITE_RETRY_TEST: u32 = 60;
