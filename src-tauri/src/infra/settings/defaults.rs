...
pub const DEFAULT_CODEX_RETRY_GATEWAY_ENABLED: bool = false;
pub const DEFAULT_CODEX_RETRY_GATEWAY_SELECTED_COMMIT: &str =
    crate::infra::codex_retry_gateway::CODEX_RETRY_GATEWAY_RECOMMENDED_COMMIT;
pub const DEFAULT_CODEX_RETRY_GATEWAY_PORT: u16 =
    crate::infra::codex_retry_gateway::CODEX_RETRY_GATEWAY_DEFAULT_PORT;
pub const DEFAULT_CODEX_RETRY_GATEWAY_NODE_OVERRIDE: &str = "";
...
pub(super) const SCHEMA_VERSION_ADD_CODEX_RETRY_GATEWAY: u32 = 49;
