...
pub const DEFAULT_CODEX_REASONING_GUARD_HIT_LABEL: &str = "降智命中";
...
pub(super) const SCHEMA_VERSION_ADD_CODEX_REASONING_GUARD_HIT_LABEL: u32 = 44;
pub(super) const SCHEMA_VERSION_ADD_CODEX_REASONING_GUARD_RULE_MODE: u32 = 45;
pub(super) const SCHEMA_VERSION_ADD_CODEX_REASONING_GUARD_RULE_TEMPLATES: u32 = 46;
pub(super) const SCHEMA_VERSION_ADD_CODEX_REASONING_GUARD_CONTINUATION_REPAIR: u32 = 47;
pub(super) const SCHEMA_VERSION_UNIFY_CODEX_REASONING_GUARD: u32 = 48;
...
pub const DEFAULT_CODEX_REASONING_GUARD_CONTINUATION_REPAIR_ENABLED: bool = false;
pub const DEFAULT_CODEX_REASONING_GUARD_CONTINUATION_MAX_ROUNDS: u32 = 3;
pub const DEFAULT_CODEX_REASONING_GUARD_CONTINUATION_MAX_OUTPUT_TOKENS: u32 = 0;
pub const CODEX_REASONING_GUARD_TEMPLATE_LEGACY_REASONING_TOKENS_ID: &str =
    "builtin-legacy-reasoning-tokens";
pub const CODEX_REASONING_GUARD_TEMPLATE_REASONING_TOKENS_518N_MINUS_2_ID: &str =
    "builtin-reasoning-tokens-518n-minus-2";
pub const CODEX_REASONING_GUARD_TEMPLATE_FINAL_ANSWER_ONLY_HIGH_XHIGH_ID: &str =
    "builtin-final-answer-only-high-xhigh";
pub const CODEX_REASONING_GUARD_TEMPLATE_LEGACY_COMPATIBILITY_ID: &str = "legacy-compatibility";
...
pub const MAX_CODEX_REASONING_GUARD_CONTINUATION_MAX_ROUNDS: u32 = 10;
pub const MAX_CODEX_REASONING_GUARD_CONTINUATION_MAX_OUTPUT_TOKENS: u32 = 200_000;
pub const MAX_CODEX_REASONING_GUARD_MODEL_FALLBACKS_LEN: usize = 16;
pub const MAX_CODEX_REASONING_GUARD_CUSTOM_TEMPLATES: usize = 32;
pub const MAX_CODEX_REASONING_GUARD_TEMPLATE_RULES: usize =
    MAX_CODEX_REASONING_GUARD_MODEL_RULES_LEN * MAX_CODEX_REASONING_GUARD_REASONING_EQUALS_LEN
        + MAX_CODEX_REASONING_GUARD_REASONING_EQUALS_LEN;
pub const MAX_CODEX_REASONING_GUARD_TEMPLATE_RULE_FILTERS: usize = 16;
pub const MAX_CODEX_REASONING_GUARD_TEMPLATE_ID_LEN: usize = 96;
pub const MAX_CODEX_REASONING_GUARD_TEMPLATE_NAME_LEN: usize = 128;
pub const MAX_CODEX_REASONING_GUARD_STRING_FILTER_LIST_LEN: usize = 32;
pub const MAX_CODEX_REASONING_GUARD_STRING_FILTER_VALUE_LEN: usize = 128;
