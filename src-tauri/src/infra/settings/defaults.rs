...
pub const DEFAULT_NATURAL_PROBE_MAX_WAIT_SECONDS: u32 = 300;
...
pub const DEFAULT_STREAM_INTERNAL_ERROR_GUARD_MS: u32 = 500;
pub const MAX_STREAM_INTERNAL_ERROR_GUARD_MS: u32 = 5_000;
...
pub const DEFAULT_CODEX_INFINITE_RETRY_TEST_ENABLED: bool = false;
pub const DEFAULT_CODEX_INFINITE_RETRY_TEST_INTERVAL_MS: u32 = 1_000;
pub const MAX_CODEX_INFINITE_RETRY_TEST_INTERVAL_MS: u32 = 60_000;
pub const DEFAULT_CODEX_GPT56_372K_CONTEXT_ENABLED: bool = false;
...
pub(super) const SCHEMA_VERSION_ADD_PROVIDER_FAILBACK: u32 = 54;
pub(super) const SCHEMA_VERSION_ADD_UPSTREAM_ERROR_RESPONSE_RULES: u32 = 55;
pub(super) const SCHEMA_VERSION_ADD_STREAM_INTERNAL_ERROR_RETRY: u32 = 56;
pub(super) const SCHEMA_VERSION_ADD_MODEL_ROUTING_POLICY: u32 = 57;
pub(super) const SCHEMA_VERSION_ADD_UPDATE_CHANNEL: u32 = 58;
pub(super) const SCHEMA_VERSION_ADD_STREAM_TERMINAL_FIREWALL: u32 = 59;
pub(super) const SCHEMA_VERSION_MIGRATE_STREAM_TERMINAL_FIREWALL: u32 = 60;
pub(super) const SCHEMA_VERSION_ADD_CODEX_INFINITE_RETRY_TEST: u32 = 61;
pub(super) const SCHEMA_VERSION_RESTORE_CYBER_PASSTHROUGH: u32 = 62;
pub(super) const SCHEMA_VERSION_ADD_CX2CC_REASONING_EFFORT_MAPPINGS: u32 = 63;
pub(super) const SCHEMA_VERSION_ADD_CODEX_GPT56_372K_CONTEXT: u32 = 64;
...
pub const MAX_CX2CC_REASONING_EFFORT_MAPPINGS: usize = 32;
pub const MAX_CX2CC_REASONING_EFFORT_BYTES: usize = 64;
...
pub(super) const MAX_NATURAL_PROBE_MAX_WAIT_SECONDS: u32 = 24 * 60 * 60;
...
pub const MAX_UPSTREAM_RETRY_POLICY_HTTP_RULES: usize = 17;
pub const MAX_UPSTREAM_RETRY_POLICY_BODY_CONTAINS: usize = 16;
pub const MAX_UPSTREAM_RETRY_POLICY_BODY_CONTAINS_CHARS: usize = 512;
pub const MAX_UPSTREAM_RETRY_POLICY_DESCRIPTION_CHARS: usize = 256;
pub const MAX_UPSTREAM_RETRY_POLICY_TRANSPORT_ERRORS: usize = 8;
pub const MAX_UPSTREAM_STREAM_INTERNAL_ERROR_KEYWORDS: usize = 16;
pub const MAX_UPSTREAM_STREAM_INTERNAL_ERROR_KEYWORD_CHARS: usize = 512;
pub const MAX_UPSTREAM_RETRY_POLICY_MAX_RETRIES: u32 = 10;
pub const MAX_UPSTREAM_RETRY_POLICY_BACKOFF_MS: u32 = 60_000;
pub const DEFAULT_CAPACITY_RETRY_KEYWORD: &str = "selected model is at capacity";
pub(super) const DEFAULT_CYBER_PASSTHROUGH_KEYWORD: &str = "high-risk cyber";
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULES: usize = 32;
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULE_NAME_CHARS: usize = 100;
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULE_DESCRIPTION_CHARS: usize = 256;
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULE_STATUS_CODES: usize = 16;
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULE_KEYWORDS: usize = 16;
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULE_KEYWORD_CHARS: usize = 512;
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULE_PROVIDER_IDS: usize = 128;
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULE_PRIORITY: u32 = 9_999;
pub const MAX_UPSTREAM_ERROR_RESPONSE_RULE_MESSAGE_CHARS: usize = 4_096;
