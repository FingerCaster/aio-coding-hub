...
mod tests {
    ...
    fn provider_with_5h_limit(id: i64) -> providers::ProviderForGateway {
        providers::ProviderForGateway {
            ...
            provider_uuid: "test-provider-uuid".to_string(),
...
INSERT INTO providers (
  provider_uuid, cli_key, name, base_url, api_key_plaintext, created_at, updated_at, window_5h_start_ts
) VALUES (?2, 'codex', 'overflow-provider', 'https://example.com', 'test-key', 1, 1, ?1)
"#,
            rusqlite::params![WINDOW_START_UNIX, crate::shared::uuid::new_uuid_v4()],
        )
...
"#,
        ...
        let ctx = CommonCtx::from(CommonCtxArgs {
            ...
            stream_internal_error_guard: std::time::Duration::ZERO,
