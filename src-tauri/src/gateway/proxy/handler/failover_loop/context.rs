...
pub(super) struct CommonCtxArgs<'a, R: tauri::Runtime = tauri::Wry> {
    ...
    pub(super) infinite_retry_ledger:
        Option<&'a crate::gateway::infinite_retry::SharedInfiniteRetryLedger>,
    ...
    pub(super) stream_internal_error_guard: Duration,
...
impl<'a, R: tauri::Runtime> CommonCtx<'a, R> {
    pub(super) fn new(args: CommonCtxArgs<'a, R>) -> Self {
        Self {
            ...
            session_binding_request: args.session_binding_request,
            ...
            provider_health_mode: args.provider_health_mode,
            infinite_retry_ledger: args.infinite_retry_ledger,
            ...
            stream_internal_error_guard: args.stream_internal_error_guard,
...
pub(super) struct CommonCtxOwned<'a, R: tauri::Runtime = tauri::Wry> {
    ...
    pub(super) provider_health_mode: crate::gateway::infinite_retry::ProviderHealthMode,
    pub(super) infinite_retry_ledger:
        Option<crate::gateway::infinite_retry::SharedInfiniteRetryLedger>,
    pub(super) provider_cooldown_secs: i64,
    pub(super) upstream_first_byte_timeout_secs: u32,
    pub(super) upstream_first_byte_timeout: Option<Duration>,
    pub(super) upstream_stream_idle_timeout: Option<Duration>,
...
impl<'a, R: tauri::Runtime> From<CommonCtx<'a, R>> for CommonCtxOwned<'a, R> {
    fn from(ctx: CommonCtx<'a, R>) -> Self {
        Self {
            ...
            session_binding_request: ctx.session_binding_request,
            ...
            provider_health_mode: ctx.provider_health_mode,
            infinite_retry_ledger: ctx.infinite_retry_ledger.cloned(),
            ...
            stream_internal_error_guard: ctx.stream_internal_error_guard,
