...
pub(in crate::gateway) enum GatewayErrorCode {
    ...
    InternalError,
    BodyTooLarge,
    InvalidRequestContentEncoding,
    LargeBodyMissingModel,
    ManagedModelInvalid,
    ConfiguredModelRouteApplyFailed,
    BridgeUnsupportedFeature,
    InvalidCliKey,
    InvalidBaseUrl,
    PortInUse,
    ResponseBuildError,
...
impl GatewayErrorCode {
    pub(in crate::gateway) const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::InvalidRequestContentEncoding => "GW_INVALID_REQUEST_CONTENT_ENCODING",
            Self::LargeBodyMissingModel => "GW_LARGE_BODY_MISSING_MODEL",
            Self::ManagedModelInvalid => "GW_MANAGED_MODEL_INVALID",
            Self::ConfiguredModelRouteApplyFailed => "GW_CONFIGURED_MODEL_ROUTE_APPLY_FAILED",
            Self::BridgeUnsupportedFeature => "GW_BRIDGE_UNSUPPORTED_FEATURE",
            ...
            Self::ProviderAccountUsageBlocked => "GW_PROVIDER_ACCOUNT_USAGE_BLOCKED",
    ...
    pub(in crate::gateway) fn from_str(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "GW_INVALID_REQUEST_CONTENT_ENCODING" => Self::InvalidRequestContentEncoding,
            "GW_LARGE_BODY_MISSING_MODEL" => Self::LargeBodyMissingModel,
            "GW_MANAGED_MODEL_INVALID" => Self::ManagedModelInvalid,
            "GW_CONFIGURED_MODEL_ROUTE_APPLY_FAILED" => Self::ConfiguredModelRouteApplyFailed,
            "GW_BRIDGE_UNSUPPORTED_FEATURE" => Self::BridgeUnsupportedFeature,
            ...
            "GW_PROVIDER_ACCOUNT_USAGE_BLOCKED" => Self::ProviderAccountUsageBlocked,
...
mod tests {
    ...
    const ALL_CODES: &[GatewayErrorCode] = &[
        ...
        GatewayErrorCode::InvalidRequestContentEncoding,
        GatewayErrorCode::LargeBodyMissingModel,
        GatewayErrorCode::ManagedModelInvalid,
        GatewayErrorCode::ConfiguredModelRouteApplyFailed,
        GatewayErrorCode::BridgeUnsupportedFeature,
