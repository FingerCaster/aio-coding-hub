...
macro_rules! generated_command_registry {
    ($callback:ident) => {{
        $callback! {
            // ── settings ──
            omp_settings_read => crate::commands::omp_settings::omp_settings_read,
            omp_settings_save => crate::commands::omp_settings::omp_settings_save,
            omp_agent_read => crate::commands::omp_settings::omp_agent_read,
            omp_agent_save => crate::commands::omp_settings::omp_agent_save,
            ...
            cli_manager_pi_info_get => crate::commands::cli_manager::cli_manager_pi_info_get,
            cli_manager_omp_info_get => crate::commands::cli_manager::cli_manager_omp_info_get,
            ...
            native_cli_check_latest_version => crate::commands::cli_update::native_cli_check_latest_version,
            native_cli_update => crate::commands::cli_update::native_cli_update,
            // ── gateway ──
            ...
            // ── providers ──
            native_cli_targets_list => crate::commands::native_cli::native_cli_targets_list,
            native_cli_target_validate => crate::commands::native_cli::native_cli_target_validate,
            native_cli_target_select => crate::commands::native_cli::native_cli_target_select,
            native_cli_providers_list => crate::commands::native_cli::native_cli_providers_list,
            native_cli_provider_read_for_edit => crate::commands::native_cli::native_cli_provider_read_for_edit,
            native_cli_provider_save => crate::commands::native_cli::native_cli_provider_save,
            native_cli_provider_apply => crate::commands::native_cli::native_cli_provider_apply,
            native_cli_provider_remove => crate::commands::native_cli::native_cli_provider_remove,
            native_cli_provider_delete => crate::commands::native_cli::native_cli_provider_delete,
            native_channel_catalog_preview => crate::commands::native_channels::native_channel_catalog_preview,
            native_channel_preview => crate::commands::native_channels::native_channel_preview,
            native_channel_apply => crate::commands::native_channels::native_channel_apply,
            native_channel_models_get => crate::commands::native_channels::native_channel_models_get,
            native_channel_models_discover => crate::commands::native_channels::native_channel_models_discover,
            native_channel_models_set => crate::commands::native_channels::native_channel_models_set,
            native_gateway_models_get => crate::commands::native_gateway::native_gateway_models_get,
            native_gateway_models_set => crate::commands::native_gateway::native_gateway_models_set,
            native_gateway_catalog_preview => crate::commands::native_gateway::native_gateway_catalog_preview,
            native_gateway_apply => crate::commands::native_gateway::native_gateway_apply,
            native_gateway_remove => crate::commands::native_gateway::native_gateway_remove,
            native_gateway_import_preview => crate::commands::native_gateway::native_gateway_import_preview,
            native_gateway_import_confirm => crate::commands::native_gateway::native_gateway_import_confirm,
            ...
            provider_account_usage_snapshot => crate::commands::providers::provider_account_usage_snapshot,
            provider_account_usage_refresh => crate::commands::providers::provider_account_usage_refresh,
            provider_account_usage_desktop_lease_acquire => crate::commands::providers::provider_account_usage_desktop_lease_acquire,
            provider_account_usage_desktop_lease_heartbeat => crate::commands::providers::provider_account_usage_desktop_lease_heartbeat,
            provider_account_usage_desktop_lease_release => crate::commands::providers::provider_account_usage_desktop_lease_release,
