...
describe("components/home/HomeRequestLogsPanel", () => {
      ...
      <MemoryRouter>
        <HomeRequestLogsPanel
          ...
          requestLogs={makeRequestLogs([
            ...
            {
              id: 46,
              trace_id: "t-continuation-repair",
              cli_key: "codex",
              method: "POST",
              path: "/v1/responses",
              requested_model: "gpt-5.5",
      ...
      <MemoryRouter>
        <HomeRequestLogsPanel
          ...
          requestLogs={makeRequestLogs([
            {
              id: 47,
              trace_id: "t-mixed-guard-continuation",
              cli_key: "codex",
              method: "POST",
              path: "/v1/responses",
              requested_model: "gpt-5.5",
              ...
              final_provider_name: "Provider C",
              created_at: TEST_CREATED_AT_SECONDS,
            },
          ])}
          requestLogsLoading={false}
  ...
  it("renders Codex model route mismatch and system request signals together", () => {
    ...
    expect(screen.getByText("Codex 系统请求")).toBeInTheDocument();
