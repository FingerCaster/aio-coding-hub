...
export type AppSettingsPatch = Partial<
  Omit<AppSettings, "update_channel" | "codex_model_context_rules">
> & {
...
type DedicatedCodexModelContextRulesViewKey = Extract<
  keyof AppSettings,
...
>;
type OrdinaryCodexModelContextRulesInputKey = Extract<
  keyof FrontendSettingsUpdate | keyof FrontendSettingsPatch,
...
/** Codex context rules are read-only here and owned only by their catalog transaction. */
export type __AssertCodexModelContextRulesExcludedFromOrdinarySettings =
  AssertNever<OrdinaryCodexModelContextRulesInputKey>;
...
const SETTINGS_VIEW_TO_UPDATE_FIELD_MAP = {
  ...
  providerFailbackStrategy: "provider_failback_strategy",
  naturalProbeMaxWaitSeconds: "natural_probe_max_wait_seconds",
  ...
  streamInternalErrorGuardMs: "stream_internal_error_guard_ms",
  ...
  codexInfiniteRetryTestEnabled: "codex_infinite_retry_test_enabled",
  codexInfiniteRetryTestIntervalMs: "codex_infinite_retry_test_interval_ms",
...
type SettingsViewKeysHandledOutsideCreateInput =
  ...
  | DedicatedCodexModelContextRulesViewKey
...
function toGeneratedSettingsUpdate(input: SettingsSetInput): FrontendSettingsUpdate {
  const update: FrontendSettingsUpdate = {
    ...
    providerFailbackStrategy: input.providerFailbackStrategy ?? null,
    naturalProbeMaxWaitSeconds: input.naturalProbeMaxWaitSeconds ?? null,
    ...
    streamInternalErrorGuardMs: input.streamInternalErrorGuardMs ?? null,
    ...
    codexInfiniteRetryTestEnabled: input.codexInfiniteRetryTestEnabled ?? null,
    codexInfiniteRetryTestIntervalMs: input.codexInfiniteRetryTestIntervalMs ?? null,
