...
export const commands = {
  ...
  async codexRetryGatewayStatus(): Promise<Result<CodexRetryGatewayStatus, string>> {
    try {
      return { status: "ok", data: await TAURI_INVOKE("codex_retry_gateway_status") };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
    }
  },
  async codexRetryGatewayEnablePlan(): Promise<Result<CodexRetryGatewayEnablePlan, string>> {
    try {
      return { status: "ok", data: await TAURI_INVOKE("codex_retry_gateway_enable_plan") };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
    }
  ...
  async codexRetryGatewaySetEnabled(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("codex_retry_gateway_set_enabled", { request }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async codexRetryGatewayCheckUpdate(): Promise<
    Result<CodexRetryGatewayUpdateCandidate | null, string>
  > {
    try {
      return { status: "ok", data: await TAURI_INVOKE("codex_retry_gateway_check_update") };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
    }
  },
  async codexRetryGatewayValidateCommit(
    request: CodexRetryGatewayValidateCommitRequest
  ): Promise<Result<CodexRetryGatewayCommitValidation, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("codex_retry_gateway_validate_commit", { request }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async codexRetryGatewayApplyCommit(
    request: CodexRetryGatewayApplyCommitRequest
  ): Promise<Result<CodexRetryGatewayStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("codex_retry_gateway_apply_commit", { request }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async codexRetryGatewaySetNodeOverride(
    request: CodexRetryGatewaySetNodeOverrideRequest
  ): Promise<Result<CodexRetryGatewayNodeStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("codex_retry_gateway_set_node_override", { request }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async codexRetryGatewayRetry(
    request: CodexRetryGatewayGenerationRequest
  ): Promise<Result<CodexRetryGatewayStatus, string>> {
    try {
      return { status: "ok", data: await TAURI_INVOKE("codex_retry_gateway_retry", { request }) };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
    }
  },
  async codexRetryGatewayUninstall(
    request: CodexRetryGatewayUninstallRequest
  ): Promise<Result<CodexRetryGatewayStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("codex_retry_gateway_uninstall", { request }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async codexRetryGatewayCreateDetailsSession(): Promise<
...
export type CodexProviderSyncPlan = {
  current_provider: string | null;
  target_provider: string;
  change_required: boolean;
  codex_must_be_closed: boolean;
};
...
export type CodexRetryGatewayApplyCommitRequest = {
  ...
  acceptedUnreviewedCommit: boolean;
};
export type CodexRetryGatewayCommitValidation = {
  requested_commit: string;
  canonical_commit: string | null;
  official_main_commit: string | null;
  official_main_ancestor: boolean;
  trust_state: CodexRetryGatewayTrustState | null;
  summary: string | null;
  error: CodexRetryGatewayError | null;
};
export type CodexRetryGatewayDetailsSession = {
  generation: number;
  iframe_url: string;
  browser_url: string;
...
export type CodexRetryGatewayEnableConfirmation = {
  acceptedFirstDownload: boolean;
  acceptedUnreviewedCommit: boolean;
  acceptedCliProxyEnable: boolean;
  acceptedProviderSync: boolean;
  acceptedWslUnprotected: boolean;
};
export type CodexRetryGatewayEnablePlan = {
  generation: number;
  selected_commit: string;
  trust_state: CodexRetryGatewayTrustState;
  first_download_required: boolean;
  unreviewed_commit: boolean;
  cli_proxy_enable_required: boolean;
  provider_sync: CodexProviderSyncPlan;
  node_status: CodexRetryGatewayNodeStatus;
  preferred_port: number;
  wsl_codex_unprotected: boolean;
};
export type CodexRetryGatewayError = {
  code: string;
  category: CodexRetryGatewayErrorCategory;
  message: string;
  retryable: boolean;
};
export type CodexRetryGatewayErrorCategory =
  | "source_resolution"
  | "source_archive"
  | "node_missing"
  | "node_unsupported"
  ...
  | "cleanup"
  | "internal";
export type CodexRetryGatewayGenerationRequest = { generation: number };
export type CodexRetryGatewayNodeResolutionSource =
  | "unavailable"
  | "codex_sibling"
  | "aio_discovery"
  | "process_path"
  | "manual_override";
export type CodexRetryGatewayNodeStatus = {
  available: boolean;
...
export type CodexRetryGatewayProcessPhase =
  | "stopped"
  | "starting"
  | "healthy"
  | "unhealthy"
  | "ownership_mismatch";
export type CodexRetryGatewayProcessStatus = {
  phase: CodexRetryGatewayProcessPhase;
  owned: boolean;
  healthy: boolean;
...
export type CodexRetryGatewayRuntimePhase =
  ...
  | "uninstalling"
  | "error";
export type CodexRetryGatewaySetEnabledRequest = {
  enabled: boolean;
  planGeneration: number;
...
export type CodexRetryGatewayStatus = {
  generation: number;
  desired_enabled: boolean;
  runtime_phase: CodexRetryGatewayRuntimePhase;
  route_mode: CodexRouteMode;
  cli_proxy_enabled: boolean;
  cli_proxy_applied: boolean;
  ...
  trust_state: CodexRetryGatewayTrustState;
  node_status: CodexRetryGatewayNodeStatus;
  process_status: CodexRetryGatewayProcessStatus;
  update_candidate: CodexRetryGatewayUpdateCandidate | null;
  wsl_codex_unprotected: boolean;
  last_error: CodexRetryGatewayError | null;
  details_available: boolean;
  operation_pending: boolean;
};
export type CodexRetryGatewayTrustState =
  | "unavailable"
  | "aio_reviewed_recommendation"
  | "official_main_unreviewed";
export type CodexRetryGatewayUninstallRequest = {
  generation: number;
  confirmedDataRemoval: boolean;
};
export type CodexRetryGatewayUpdateCandidate = {
  commit: string;
...
export type CodexRetryGatewayValidateCommitRequest = { commit: string };
export type CodexRouteMode = "unproxied" | "direct_aio" | "guarded";
